...
const TareaState = (props) => {
  const initialState = {
    tareas: [
      ...
      { id: 13, nombre: "Elegir Hosting Fontend", estado: true, proyectoId: 1 },
      { id: 14, nombre: "Elegir Hosting Backend", estado: true, proyectoId: 2 },
      {
        id: 15,
        nombre: "Elegir  diseño",
        estado: true,
        proyectoId: 3,
      },
      {
        id: 16,
        nombre: "Elegir Plataforma de diseño",
        estado: true,
        proyectoId: 3,
      },
